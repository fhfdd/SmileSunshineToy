...
{
    public partial class InvProDetail : Form
    {
        public InvProDetail()
        {
            InitializeComponent();
        ...
        private void InvProDetail_Load(object sender, EventArgs e)
        {
        ...
        private void saleAllSearch_Click(object sender, EventArgs e)
        {

        }

        private void saleSearch_TextChanged(object sender, EventArgs e)
        {
