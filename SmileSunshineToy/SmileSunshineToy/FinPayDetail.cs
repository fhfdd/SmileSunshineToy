...
{
    public partial class FinPayDetail : Form
    {
        public FinPayDetail()
        {
            InitializeComponent();
        ...
        private void labelRequirement_Click(object sender, EventArgs e)
        {
        ...
        private void labelRemark_Click(object sender, EventArgs e)
        {
